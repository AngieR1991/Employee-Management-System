 ...
 * FILE: main.cpp
 * DESC: employee record management system
 ******************************************************************/
#include <iostream>
using namespace std;
...
void enter()
{
    ...
    {
        for (int i = total; i < numOfEmp + total; i++) // to store onward students' data rather than storing double data
        {
            cout << "\nEnter the Data of Employee " << i + 1 << endl << endl;
            cout << "** PERSONAL DETAILS **" << endl << endl;
            cout << "Enter Name: " << endl;
        ...
        total = numOfEmp + total; // making choice
    }
}
...
void show()
{
    ...
    else
    {
        ...
        {
            cout << "** RESULT FOR SHOW DATA **" << endl << endl;
...
{
    int value = 0;
    cout << ">>>>>>>>  EMPLOYEE RECORD MANAGEMENT SYSTEM  <<<<<<<<" << endl << endl;
